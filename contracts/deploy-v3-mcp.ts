...
async function deployContractV3(contractName: string, constructorCalldata: any[]) {
    console.log(`\n🚀 Desplegando ${contractName} con transacciones V3...`);
    ...
    try {
        ...
        console.log(`🛠️ Desplegando instancia de ${contractName} con V3...`);
        
        // Desplegar el contrato con V3
...
async function main() {
    console.log("🚀 Desplegando contratos REALES con transacciones V3...");
    console.log(`💰 Cuenta: ${ACCOUNT_ADDRESS}`);
    console.log(`🌐 RPC: ${RPC_URL}`);
    console.log("🎯 Iniciando deployment REAL con V3 en Starknet Sepolia...\n");
    ...
    try {
        ...
        console.log("\n🚀 Iniciando deployment de contratos con V3...");
        
        const paymentProcessor = await deployContractV3("PaymentProcessor", [ownerAddress]);
        const remesaVault = await deployContractV3("RemesaVault", [ownerAddress]);
        const tandaSavings = await deployContractV3("TandaSavings", [ownerAddress]);
        ...
        const deployedConfig = {
            ...
            deployment: {
                ...
                method: "v3_mcp_cairo_real_deployment",
            },
        };
        ...
        console.log("\n🎉 ¡Deployment REAL con V3 completado exitosamente!");
