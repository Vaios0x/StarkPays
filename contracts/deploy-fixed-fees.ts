...
async function deployContractWithFixedFees(contractName: string, constructorCalldata: any[]) {
    console.log(`\n🚀 Desplegando ${contractName} con fees fijos...`);
    ...
    try {
        ...
        // Configurar resource bounds explícitos para evitar problemas de estimación
        const resourceBounds = {
            l1_gas: {
                max_amount: "0x186a0", // 100,000 en hex
                max_price_per_unit: "0x5f5e100" // 100,000,000 en hex (100 gwei)
            },
            l2_gas: {
                max_amount: "0x186a0", // 100,000 en hex
                max_price_per_unit: "0x0" // 0 en hex (L2 gas es gratis)
            }
        };

        // Declarar el contrato con resource bounds explícitos
        ...
        // Desplegar el contrato con resource bounds explícitos
...
async function main() {
    console.log("🚀 Desplegando contratos REALES con fees fijos...");
    console.log(`💰 Cuenta: ${ACCOUNT_ADDRESS}`);
    console.log(`🌐 RPC: ${RPC_URL}`);
    console.log("🎯 Iniciando deployment REAL con fees fijos en Starknet Sepolia...\n");
    ...
    try {
        ...
        console.log("\n🚀 Iniciando deployment de contratos con fees fijos...");
        
        const paymentProcessor = await deployContractWithFixedFees("PaymentProcessor", [ownerAddress]);
        const remesaVault = await deployContractWithFixedFees("RemesaVault", [ownerAddress]);
        const tandaSavings = await deployContractWithFixedFees("TandaSavings", [ownerAddress]);
        ...
        const deployedConfig = {
            ...
            deployment: {
                ...
                method: "fixed_fees_mcp_cairo_real_deployment",
            },
        };
        ...
        console.log("\n🎉 ¡Deployment REAL con fees fijos completado exitosamente!");
