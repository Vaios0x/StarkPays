...
async function deployContractWithoutFeeEstimation(contractName: string, constructorCalldata: any[]) {
    console.log(`\n🚀 Desplegando ${contractName} sin estimación de fees...`);
    ...
    try {
        ...
        // Usar transacciones V2 para evitar problemas de V3
...
async function main() {
    console.log("🚀 Desplegando contratos REALES sin estimación de fees...");
    console.log(`💰 Cuenta: ${ACCOUNT_ADDRESS}`);
    console.log(`🌐 RPC: ${RPC_URL}`);
    console.log("🎯 Iniciando deployment REAL sin estimación de fees en Starknet Sepolia...\n");
    ...
    try {
        ...
        console.log("\n🚀 Iniciando deployment de contratos sin estimación de fees...");
        
        const paymentProcessor = await deployContractWithoutFeeEstimation("PaymentProcessor", [ownerAddress]);
        const remesaVault = await deployContractWithoutFeeEstimation("RemesaVault", [ownerAddress]);
        const tandaSavings = await deployContractWithoutFeeEstimation("TandaSavings", [ownerAddress]);
        ...
        const deployedConfig = {
            ...
            deployment: {
                ...
                method: "no_fee_estimation_mcp_cairo_real_deployment",
            },
        };
        ...
        console.log("\n🎉 ¡Deployment REAL sin estimación de fees completado exitosamente!");
