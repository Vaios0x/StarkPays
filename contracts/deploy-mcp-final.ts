...
async function deployContractMCP(contractName: string, constructorCalldata: any[]) {
    ...
    try {
        ...
        console.log(`📋 Declarando ${contractName} con MCP...`);
        
        // Usar transacciones V0 para evitar problemas de estimación
...
async function main() {
    ...
    try {
        ...
        console.log("\n🚀 Iniciando deployment de contratos con MCP de Cairo...");
        ...
        const deployedConfig = {
            ...
            deployment: {
                ...
                method: "mcp_cairo_final_deployment",
            },
        };
