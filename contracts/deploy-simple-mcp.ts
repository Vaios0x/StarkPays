...
async function deployContractSimpleMCP(contractName: string, constructorCalldata: any[]) {
    console.log(`\n🚀 Desplegando ${contractName} con MCP simple...`);
...
async function main() {
    console.log("🚀 Desplegando contratos REALES con MCP simple...");
    console.log(`💰 Cuenta: ${ACCOUNT_ADDRESS}`);
    console.log(`🌐 RPC: ${RPC_URL}`);
    console.log("🎯 Iniciando deployment REAL con MCP simple en Starknet Sepolia...\n");
    ...
    try {
        ...
        console.log("\n🚀 Iniciando deployment de contratos con MCP simple...");
        
        const paymentProcessor = await deployContractSimpleMCP("PaymentProcessor", [ownerAddress]);
        const remesaVault = await deployContractSimpleMCP("RemesaVault", [ownerAddress]);
        const tandaSavings = await deployContractSimpleMCP("TandaSavings", [ownerAddress]);
        ...
        const deployedConfig = {
            ...
            deployment: {
                ...
                method: "simple_mcp_cairo_real_deployment",
            },
        };
        ...
        console.log("\n🎉 ¡Deployment REAL con MCP simple completado exitosamente!");
